...
class SpecHelp(object):
    ...
    def express(self):   
        ...
        print("        using this scheme <root_results_dir>/<master_job_name>/<trial>/<permCode>")
        print("        where permCode is built from the permute variables and values")
        print("        NOTE : root_results_dir is defined by the user in the cspec (see below)")
        print("        NOTE : master_job_name is defined by the user in the cspec (see below)")
        ...
        print("############################################################################")
        print("script_dir:<project_root>/<master_job_name>/scripts")
        print("  ")
        print("  ")
        print("############################################################################")
