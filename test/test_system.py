...
class TestSystem(unittest.TestCase):
    ...
    def test_preview(self):
        ...
        self.assertTrue(stdout.lines[3] == "#$ -cwd\n")
        self.assertTrue(stdout.lines[4] == "#$ -q eecs,eecs1,eecs,share\n")
        self.assertTrue(stdout.lines[5] == "#$ -M someone@gmail.com\n")
        self.assertTrue(stdout.lines[6] == "#$ -m beas\n")
        self.assertTrue(stdout.lines[7] == "#$ -N baz-j100_an_cat_l_aa_number_1_s_300_trial_1\n")
        self.assertTrue(stdout.lines[8] == "#\n")
        self.assertTrue(stdout.lines[9] == "# send stdout and stderror to this file\n")
        self.assertTrue(stdout.lines[10] == "#$ -o j100_an_cat_l_aa_number_1_s_300_trial_1.out\n")
        self.assertTrue(stdout.lines[11] == "#$ -e j100_an_cat_l_aa_number_1_s_300_trial_1.err\n")
        self.assertTrue(stdout.lines[12] == "#\n")
        self.assertTrue(stdout.lines[13] == "#see where the job is being run\n")
        self.assertTrue(stdout.lines[14] == "hostname\n")
        # CANT TEST next line and keep tests portable now that relative paths resolved
