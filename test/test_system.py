...
class TestSystem(unittest.TestCase):
    ...
    def test_preview(self):
        ...
        self.assertTrue(stdout.stdout[13] == "echo AAA 1 300 > ./myRuns/baz/an_cat_l_aa_number_1_s_300_trial_1/AAA_1_one.txt\n")
...
'''        
    def test_generate(self):
        ...
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j100_1_an_cat_l_aa_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j101_2_an_cat_l_aa_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j102_1_an_cat_l_aa_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j103_2_an_cat_l_aa_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j104_1_an_cat_l_aa_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j105_2_an_cat_l_aa_number_3_s_300.sh'))
        
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j106_1_an_cat_l_bb_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j107_2_an_cat_l_bb_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j108_1_an_cat_l_bb_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j109_2_an_cat_l_bb_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j110_1_an_cat_l_bb_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j111_2_an_cat_l_bb_number_3_s_300.sh'))
        
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j112_1_an_dog_l_aa_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j113_2_an_dog_l_aa_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j114_1_an_dog_l_aa_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j115_2_an_dog_l_aa_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j116_1_an_dog_l_aa_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j117_2_an_dog_l_aa_number_3_s_300.sh'))
        
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j118_1_an_dog_l_bb_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j119_2_an_dog_l_bb_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j120_1_an_dog_l_bb_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j121_2_an_dog_l_bb_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j122_1_an_dog_l_bb_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j123_2_an_dog_l_bb_number_3_s_300.sh'))
        
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j100_1_an_cat_l_aa_number_1_s_300.sh','echo AAA 1 300 > ./sample_results/unittest/trial1/an_cat_l_aa_number_1_s_300/AAA_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j101_2_an_cat_l_aa_number_1_s_300.sh','echo AAA 1 300 > ./sample_results/unittest/trial2/an_cat_l_aa_number_1_s_300/AAA_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j102_1_an_cat_l_aa_number_2_s_300.sh','echo AAA 2 300 > ./sample_results/unittest/trial1/an_cat_l_aa_number_2_s_300/AAA_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j103_2_an_cat_l_aa_number_2_s_300.sh','echo AAA 2 300 > ./sample_results/unittest/trial2/an_cat_l_aa_number_2_s_300/AAA_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j104_1_an_cat_l_aa_number_3_s_300.sh','echo AAA 3 300 > ./sample_results/unittest/trial1/an_cat_l_aa_number_3_s_300/AAA_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j105_2_an_cat_l_aa_number_3_s_300.sh','echo AAA 3 300 > ./sample_results/unittest/trial2/an_cat_l_aa_number_3_s_300/AAA_3_three.txt'))
        
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j106_1_an_cat_l_bb_number_1_s_300.sh','echo BBB 1 300 > ./sample_results/unittest/trial1/an_cat_l_bb_number_1_s_300/BBB_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j107_2_an_cat_l_bb_number_1_s_300.sh','echo BBB 1 300 > ./sample_results/unittest/trial2/an_cat_l_bb_number_1_s_300/BBB_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j108_1_an_cat_l_bb_number_2_s_300.sh','echo BBB 2 300 > ./sample_results/unittest/trial1/an_cat_l_bb_number_2_s_300/BBB_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j109_2_an_cat_l_bb_number_2_s_300.sh','echo BBB 2 300 > ./sample_results/unittest/trial2/an_cat_l_bb_number_2_s_300/BBB_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j110_1_an_cat_l_bb_number_3_s_300.sh','echo BBB 3 300 > ./sample_results/unittest/trial1/an_cat_l_bb_number_3_s_300/BBB_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j111_2_an_cat_l_bb_number_3_s_300.sh','echo BBB 3 300 > ./sample_results/unittest/trial2/an_cat_l_bb_number_3_s_300/BBB_3_three.txt'))
        
        
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j112_1_an_dog_l_aa_number_1_s_300.sh','echo AAA 1 300 > ./sample_results/unittest/trial1/an_dog_l_aa_number_1_s_300/AAA_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j113_2_an_dog_l_aa_number_1_s_300.sh','echo AAA 1 300 > ./sample_results/unittest/trial2/an_dog_l_aa_number_1_s_300/AAA_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j114_1_an_dog_l_aa_number_2_s_300.sh','echo AAA 2 300 > ./sample_results/unittest/trial1/an_dog_l_aa_number_2_s_300/AAA_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j115_2_an_dog_l_aa_number_2_s_300.sh','echo AAA 2 300 > ./sample_results/unittest/trial2/an_dog_l_aa_number_2_s_300/AAA_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j116_1_an_dog_l_aa_number_3_s_300.sh','echo AAA 3 300 > ./sample_results/unittest/trial1/an_dog_l_aa_number_3_s_300/AAA_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j117_2_an_dog_l_aa_number_3_s_300.sh','echo AAA 3 300 > ./sample_results/unittest/trial2/an_dog_l_aa_number_3_s_300/AAA_3_three.txt'))
        
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j118_1_an_dog_l_bb_number_1_s_300.sh','echo BBB 1 300 > ./sample_results/unittest/trial1/an_dog_l_bb_number_1_s_300/BBB_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j119_2_an_dog_l_bb_number_1_s_300.sh','echo BBB 1 300 > ./sample_results/unittest/trial2/an_dog_l_bb_number_1_s_300/BBB_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j120_1_an_dog_l_bb_number_2_s_300.sh','echo BBB 2 300 > ./sample_results/unittest/trial1/an_dog_l_bb_number_2_s_300/BBB_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j121_2_an_dog_l_bb_number_2_s_300.sh','echo BBB 2 300 > ./sample_results/unittest/trial2/an_dog_l_bb_number_2_s_300/BBB_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j122_1_an_dog_l_bb_number_3_s_300.sh','echo BBB 3 300 > ./sample_results/unittest/trial1/an_dog_l_bb_number_3_s_300/BBB_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j123_2_an_dog_l_bb_number_3_s_300.sh','echo BBB 3 300 > ./sample_results/unittest/trial2/an_dog_l_bb_number_3_s_300/BBB_3_three.txt'))
    ...
    def test_comma_in_arg(self):
        ...
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j100_1_an_cat_l_A-A-A_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j101_2_an_cat_l_A-A-A_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j102_1_an_cat_l_A-A-A_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j103_2_an_cat_l_A-A-A_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j104_1_an_cat_l_A-A-A_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j105_2_an_cat_l_A-A-A_number_3_s_300.sh'))
        ...
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j112_1_an_dog_l_A-A-A_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j113_2_an_dog_l_A-A-A_number_1_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j114_1_an_dog_l_A-A-A_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j115_2_an_dog_l_A-A-A_number_2_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j116_1_an_dog_l_A-A-A_number_3_s_300.sh'))
        self.assertTrue(cluster_system.isfile('./myRuns/baz/scripts/j117_2_an_dog_l_A-A-A_number_3_s_300.sh'))
        ...
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j100_1_an_cat_l_A-A-A_number_1_s_300.sh','echo A,A,A 1 300 > ./sample_results/unittest/trial1/an_cat_l_A-A-A_number_1_s_300/A,A,A_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j101_2_an_cat_l_A-A-A_number_1_s_300.sh','echo A,A,A 1 300 > ./sample_results/unittest/trial2/an_cat_l_A-A-A_number_1_s_300/A,A,A_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j102_1_an_cat_l_A-A-A_number_2_s_300.sh','echo A,A,A 2 300 > ./sample_results/unittest/trial1/an_cat_l_A-A-A_number_2_s_300/A,A,A_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j103_2_an_cat_l_A-A-A_number_2_s_300.sh','echo A,A,A 2 300 > ./sample_results/unittest/trial2/an_cat_l_A-A-A_number_2_s_300/A,A,A_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j104_1_an_cat_l_A-A-A_number_3_s_300.sh','echo A,A,A 3 300 > ./sample_results/unittest/trial1/an_cat_l_A-A-A_number_3_s_300/A,A,A_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j105_2_an_cat_l_A-A-A_number_3_s_300.sh','echo A,A,A 3 300 > ./sample_results/unittest/trial2/an_cat_l_A-A-A_number_3_s_300/A,A,A_3_three.txt'))
        ...
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j112_1_an_dog_l_A-A-A_number_1_s_300.sh','echo A,A,A 1 300 > ./sample_results/unittest/trial1/an_dog_l_A-A-A_number_1_s_300/A,A,A_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j113_2_an_dog_l_A-A-A_number_1_s_300.sh','echo A,A,A 1 300 > ./sample_results/unittest/trial2/an_dog_l_A-A-A_number_1_s_300/A,A,A_1_one.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j114_1_an_dog_l_A-A-A_number_2_s_300.sh','echo A,A,A 2 300 > ./sample_results/unittest/trial1/an_dog_l_A-A-A_number_2_s_300/A,A,A_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j115_2_an_dog_l_A-A-A_number_2_s_300.sh','echo A,A,A 2 300 > ./sample_results/unittest/trial2/an_dog_l_A-A-A_number_2_s_300/A,A,A_2_two.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j116_1_an_dog_l_A-A-A_number_3_s_300.sh','echo A,A,A 3 300 > ./sample_results/unittest/trial1/an_dog_l_A-A-A_number_3_s_300/A,A,A_3_three.txt'))
        self.assertTrue(self.is_echo_line_match(cluster_system, './myRuns/baz/scripts/j117_2_an_dog_l_A-A-A_number_3_s_300.sh','echo A,A,A 3 300 > ./sample_results/unittest/trial2/an_dog_l_A-A-A_number_3_s_300/A,A,A_3_three.txt'))
    ...
    def test_clean_dir_except_for_scripts(self):   
        ...
        f.close()
        permutation_driver.clean_dir_except_for_scripts("/foo")
